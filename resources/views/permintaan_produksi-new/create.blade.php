 ...
 <div class="container">
  ...
  <div class="card">
      ...
      <div class="card-body">
        ...
        <form class="mb-4" action="/permintaan-store" method="POST">
    
            {{-- //perhatikan setiap valuenya --}}
            @csrf
            <h1 class="text-center mb-4">Permintaan Produksi</h1>
          
            <div class="form-group row">
              <label class="col-12 font-weight-bold col-form-label">Part Name <span class="text-danger">*</span></label>
              <div class="col-12">
              <select name="permintaanproduksi_id" class="form-control">
                  {{-- //jangan sampe salah valuenya --}}
                @foreach ($permintaan_produk as $masuk)
              <option value="{{$masuk->id}}">{{$masuk->part_name}}</option>  
                @endforeach
              </select>
          </div>
            </div>
        ...
        <div class="form-group row">
          <label class="col-12 font-weight-bold col-form-label">Pic <span class="text-danger">*</span></label>
          <div class="col-12">
            <input type="text" class="form-control" name="pic" placeholder="Masukkan Nama Pic">
          </div>
        </div>

        <div class="form-group row">
          <label class="col-12 font-weight-bold col-form-label">Actual<span class="text-danger">*</span></label>
          <div class="col-12">
            <input type="number" class="form-control" name="actual">
        </div> 
        </div>
        <div class="form-group row">
          <label class="col-12 font-weight-bold col-form-label">Shift<span class="text-danger">*</span></label>
          <div class="col-12">
            <input type="number" class="form-control" name="shift">
        </div> 
        </div>
        <div class="form-group row">
          <label class="col-12 font-weight-bold col-form-label">Plant Area<span class="text-danger">*</span></label>
          <div class="col-12">
        ...
        <div class="form-group row">
          <label class="col-12 font-weight-bold col-form-label">Keterangan<span class="text-danger">*</span></label>
          <div class="col-12">
