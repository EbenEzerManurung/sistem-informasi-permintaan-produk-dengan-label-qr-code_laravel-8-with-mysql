    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel"> Tambah Produk Masuk</h1>
...
<!-- AKHIR MODAL -->
 ...
 <!-- MULAI MODAL FORM TAMBAH/EDIT-->
 <div class="modal" tabindex="-1" id="edit-modal" aria-hidden="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-judul"></h5>
            ...
            <div class="modal-body">
                <form id="form-edit" name="form-edit" class="form-horizontal">
                    <div class="row">
                        <div class="col-sm-12">
...
<script>
    ...
    $(document).ready(function () {
        $('#table_masuk').DataTable({
            ...
            ajax: {
                url: "{{ route('produk_masuk.index') }}",
                type: 'GET'
            },
            columns: [
                {data: 'DT_RowIndex', searchable: false, sortable: false},
                {
                    data: 'kode_produkmasuk',
                    name: 'kode_produkmasuk'
                },
                {
                    data: 'order_no',
                    name: 'order_no'
        ...
        $("#form-tambah-edit").validate({
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('produk_masuk.index') }}", //url simpan data
                    type: "POST", //karena simpan kita pakai method POST
                    dataType: 'json', //data tipe kita kirim berupa JSON
                    success: function (data) { //jika berhasil 
                        $('#tambah-edit').trigger("reset"); //form reset
    ...
    $(document).on('click', '.edit', function () {
        ...
        $.get('produk_masuk/' + data_id + '/edit', function (data) {
            console.log(data);
    ...
    $('#tombol-hapus').click(function () {
        $.ajax({
            url: "produk_masuk/" + dataId, //eksekusi ajax ke url ini
            type: 'delete',
            beforeSend: function () {
