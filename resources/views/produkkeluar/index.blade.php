...
<body>
 ...
 <div class="container">
    ...
    @foreach($produk_keluar as $keluar)
              ...
              <td>{{ $keluar->kode_produkkeluar}}</td>
              <td>{{ $keluar->permintaan_produk->order_no }}</td>
              <td>{{ $keluar->permintaan_produk->part_no }}</td>
              <td>{{ $keluar->permintaan_produk->part_name }}</td>
              <td>{{ $keluar->permintaan_produk->qty}}</td>
              <td>{{ $keluar->permintaan_produk->uom }}</td>
