...
<html lang="en">
  <head>
    ...
    <title>Sistem informasi permintaan produk jadi dengan label QR Code</title>
        ...
        <div class="content-wrapper d-flex justify-content-center align-items-center auth login-page theme-one">
          <div class="row w-100">
            <div class="col-lg-4 mx-auto">
              <div class="auto-form-wrapper">
                ...
                <form action="{{ url('/verify_login') }}" method="post" name="login_form">
                  ...
                  <div class="form-group">
                        ...
                        <p>
                          <figure><img src="{{ asset('images/RMA-logo.jpg')}}" width="337" height="150"></figure>


                        <label>   <br>
                          
                        <h1 class="mb-2 display-4 font-weight-bold" id="greetings"></h1></label>
                        <script>
              ...
              <p class="mt-3 footer-text text-center">copyright Eben Nezer Manurung © {{date('Y')}} </p>
            </div>
          </div>
        </div>
      </div>
