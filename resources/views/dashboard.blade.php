      ...
      <div class="col-xl-3  col-sm-20 grid-margin stretch-card">
        <div class="card card-statistics">
            <div class="card-body">
              ...
              <p class="text-muted mt-3 mb-0">
                <i class="mdi mdi-poll-box " aria-hidden="true"></i> Total permintaan produk
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="card card-statistics">
            <div class="card-body">
              <div class="clearfix">
                ...
                <div class="float-right">
                  <p class="mb-0 text-right">Produk masuk</p>
                  <div class="fluid-container">
                    <h3 class="font-weight-medium text-right mb-0">{{\App\produk_masuk::count()}}</h3>
                   
                  </div>
                </div>
              </div>
              <p class="text-muted mt-3 mb-0">
                <i class=" mdi mdi-cube-outline " aria-hidden="true"></i> Total produk masuk
              </p> 
            </div>
          </div>
        </div>
          ...
          <div class="card card-statistics">
              <div class="card-body">
                <div class="clearfix">
                  ...
                  <div class="float-right">
                    <p class="mb-0 text-right">produk keluar</p>
                    <div class="fluid-container">
                      <h3 class="font-weight-medium text-right mb-0">{{\App\produk_keluar::count()}}</h3>
                    
                    </div>
                  </div>
                </div>
                <p class="text-muted mt-3 mb-0">
                  <i class="mdi mdi-cube-outline" aria-hidden="true"></i> Total keluar
                </p>
              </div>
            </div>
          </div>
